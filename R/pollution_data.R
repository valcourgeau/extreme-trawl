#' Air Pollutant Concentration on Marylebone Road, London, UK.
#'
#' A dataset containing the air pollutant concentration of six molecules:
#' Ozone (O3), Carbon Monoxide (CO), Nitric Oxide (NO), Nitric Dioxide (NO2),
#' Particulate Matter below 10mm (PM10), Sulphur Dioxide (SO2).
#'
